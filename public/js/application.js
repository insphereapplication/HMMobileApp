$(document).ready(function() {
  $('form').not('#dependent_form, #contact_new, #appdetail, #call_back_form, #appointment_form, #lost_opportunity_other_form, #reset_pin_form, #won_form, #new_task_form').submit(function() {
